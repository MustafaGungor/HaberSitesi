...
<?php 
	            ...
	            $sorgu=pg_query("select * from magazinhaber");
?>
<?php
//sessionlar alındı
 session_start();
           ...
           <?php 
		      ...
		      function deger($i){
				   ...
				   if($i==1){
						 ...
						 $a='.....<a href="/haberler/haber5.php?sayfa1">devamını oku</a>';
					     ...
					     $a='.....<a href="/haberler/haber5.php?sayfa2">devamını oku</a>';
						 
						 echo $a;
					      
					   }
				  else if($i==3){
					      $a='.....<a href="/haberler/haber5.php?sayfa3">devamını oku</a>';
						  $_GET['s']=$a;
						 echo $a;
					     
						 }
				  else if($i==4){ 
				          $a='.....<a href="/haberler/haber5.php?sayfa4">devamını oku</a>';
						  $_GET['s']=$a;
				         echo $a;
					     
						 }
				  else if($i==5){ 
				          $a='.....<a href="/haberler/haber5.php?sayfa5">devamını oku</a>';
						  $_GET['s']=$a;
				         echo $a;
					      
				  }
				  else if($i==6){
					      $a='.....<a href="/haberler/haber5.php?sayfa6">devamını oku</a>'; 
						  $_GET['s']=$a;
				         echo $a;
					     
				  }
				  else if($i==7){ 
				          $a='.....<a href="/haberler/haber5.php?sayfa7">devamını oku</a>';
						  $_GET['s']=$a;
				         echo $a;
