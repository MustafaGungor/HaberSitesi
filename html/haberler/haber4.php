...
<?php 
				...
				if($aa=='10.1.6.200/haberler/haber4.php?sayfa1'){
					 $gelensession=1;
					 $id="id='$gelensession'";
					 $sorgu=pg_query("select * from dunyagundem where $id");
					 $tiksayisi=pg_query("UPDATE dunyagundem SET tiksayisi=tiksayisi+1 WHERE $id");
					}
			     else if($aa=='10.1.6.200/haberler/haber4.php?sayfa2'){
					  $gelensession=2;
					 $id="id='$gelensession'";
					 $sorgu=pg_query("select * from dunyagundem where $id");
					  $tiksayisi=pg_query("UPDATE dunyagundem SET tiksayisi=tiksayisi+1 WHERE $id");
				...
				else if($aa=='10.1.6.200/haberler/haber4.php?sayfa3'){
					  $gelensession=3;
					 $id="id='$gelensession'";
					 $sorgu=pg_query("select * from dunyagundem where $id");
					  $tiksayisi=pg_query("UPDATE dunyagundem SET tiksayisi=tiksayisi+1 WHERE $id");
			    ...
			    else if($aa=='10.1.6.200/haberler/haber4.php?sayfa4'){
					  $gelensession=4;
					 $id="id='$gelensession'";
					 $sorgu=pg_query("select * from dunyagundem where $id");
					  $tiksayisi=pg_query("UPDATE dunyagundem SET tiksayisi=tiksayisi+1 WHERE $id");
			    ...
			    else if($aa=='10.1.6.200/haberler/haber4.php?sayfa5'){
					  $gelensession=5;
					 $id="id='$gelensession'";
					 $sorgu=pg_query("select * from dunyagundem where $id");
					  $tiksayisi=pg_query("UPDATE dunyagundem SET tiksayisi=tiksayisi+1 WHERE $id");
