...
<?php 
				...
				if($aa=='10.1.6.200/haberler/haber3.php?sayfa1'){
					 $gelensession=1;
					 $id="id='$gelensession'";
					 $sorgu=pg_query("select * from tekonolojihaber where $id");
					 $tiksayisi=pg_query("UPDATE tekonolojihaber SET tiksayisi=tiksayisi+1 WHERE $id");
					}
			     else if($aa=='10.1.6.200/haberler/haber3.php?sayfa2'){
					  $gelensession=2;
					 $id="id='$gelensession'";
					 $sorgu=pg_query("select * from tekonolojihaber where $id");
					 $tiksayisi=pg_query("UPDATE tekonolojihaber SET tiksayisi=tiksayisi+1 WHERE $id");
				...
				else if($aa=='10.1.6.200/haberler/haber3.php?sayfa3'){
					  $gelensession=3;
					 $id="id='$gelensession'";
					 $sorgu=pg_query("select * from tekonolojihaber where $id");
					 $tiksayisi=pg_query("UPDATE tekonolojihaber SET tiksayisi=tiksayisi+1 WHERE $id");
					  }
			    else if($aa=='10.1.6.200/haberler/haber3.php?sayfa4'){
					  $gelensession=4;
					 $id="id='$gelensession'";
					 $sorgu=pg_query("select * from tekonolojihaber where $id");
					 $tiksayisi=pg_query("UPDATE tekonolojihaber SET tiksayisi=tiksayisi+1 WHERE $id");
			    ...
			    else if($aa=='10.1.6.200/haberler/haber3.php?sayfa5'){
					  $gelensession=5;
					 $id="id='$gelensession'";
					 $sorgu=pg_query("select * from tekonolojihaber where $id");
					 $tiksayisi=pg_query("UPDATE tekonolojihaber SET tiksayisi=tiksayisi+1 WHERE $id");
	...
	onClick="penAcKonumTest()" />
        ...
        <div id="templatemo_content">
            ...
            <div class="content_box">
                ...
                <p><?php  /*if($uzunluk>50){
					     $detay=substr($icerik,0,50);
					     echo $detay."....."."<input type=submit > devamını oku</a>";  
					
					}
					else{ 
						echo $icerik;
						}*/echo $sonuc->habericerik; ?></p>
                

                <p></p>
                <p><?php echo $sonuc->habertarih;  ?></p><br/>
                <p><?php echo "Görüntüleme Sayısı=".$sonuc->tiksayisi; ?>
