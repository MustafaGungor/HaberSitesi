...
<?php 
				...
				$deger=0;
				$sorgu2=pg_query("update turkiyegundem set tiksayisi=tiksayisi+1");
			
			    $sorgux="select * from turkiyegundem ordey by tiksayisi desc limit 1";
...
<div id="templatemo_wrapper">
           ...
           <?php 
		      ...
		      function deger($i){
				   ...
				   if($i==1){
						 ...
						 $a='.....<a href="/haberler/haber1.php?sayfa1">devamını oku</a>';
					     ...
					     $a='.....<a href="/haberler/haber1.php?sayfa2">devamını oku</a>';
						 
						 echo $a;
					      
					   }
				  else if($i==3){
					      $a='.....<a href="/haberler/haber1.php?sayfa3">devamını oku</a>';
						  $_GET['s']=$a;
						 echo $a;
					     
						 }
				  else if($i==4){ 
				          $a='.....<a href="/haberler/haber1.php?sayfa4">devamını oku</a>';
						  $_GET['s']=$a;
				         echo $a;
					     
						 }
				  else if($i==5){ 
				          $a='.....<a href="/haberler/haber1.php?sayfa5">devamını oku</a>';
						  $_GET['s']=$a;
				         echo $a;
					      
				  }
				  else if($i==6){
					      $a='.....<a href="/haberler/haber1.php?sayfa6">devamını oku</a>'; 
						  $_GET['s']=$a;
				         echo $a;
					     
				  }
				  else if($i==7){ 
				          $a='.....<a href="/haberler/haber1.php?sayfa7">devamını oku</a>';
						  $_GET['s']=$a;
				         echo $a;
            ...
            <div class="content_box last_box">
                ...
                <div id="gallery">
                    ...
                    <a href="images/gallery/image_03_b.jpg" class="pirobox" title="Project 3"><img src="images/gallery/image_03.jpg" alt="3" width="160" height="120" /></a><br/>
    ...
    <?php
	        while( $sonuc4=pg_fetch_object($sorgux)){
             echo $sonuc4;
			}
		   ?>
    </div>
